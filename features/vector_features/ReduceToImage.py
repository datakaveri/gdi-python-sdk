...
from common.save_raster_artifact import save_raster_artifact  # NEW IMPORT
...
# def reduce_to_image(config: str, client_id: str, artifact_url: str, attribute: str, grid_size: int, reducer: str, store_artifacts: str, file_path: str = None) -> None:
#     """
