...
def clip_raster(
    ...
    In the editor this will be renamed **clip-raster**.
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        gdal.Warp(raw_clip, loc_rst, format="GTiff",
                  cutlineDSName=vsicut, cropToCutline=True,
                  dstNodata=0, callback=None)

        gdal.Translate(final_cog, raw_clip, format="COG",
        ...
        result_path = file_path if store_artifact.lower() == "minio" else final_cog
        return result_path
